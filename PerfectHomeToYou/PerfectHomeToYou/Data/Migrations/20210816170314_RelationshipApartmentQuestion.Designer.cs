...
namespace PerfectHomeToYou.Data.Migrations
{
    ...
    [Migration("20210816170314_RelationshipApartmentQuestion")]
    partial class RelationshipApartmentQuestion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PerfectHomeToYou.Data.Models.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PerfectHomeToYou.Data.Models.Neighborhood", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PerfectHomeToYou.Data.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PerfectHomeToYou.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PerfectHomeToYou.Data.Models.Apartment", b =>
                {
                    b.HasOne("PerfectHomeToYou.Data.Models.City", "City")
                        .WithMany("Apartments")
            ...
            modelBuilder.Entity("PerfectHomeToYou.Data.Models.Client", b =>
                {
                    b.HasOne("PerfectHomeToYou.Data.Models.User", null)
                        .WithOne()
                        .HasForeignKey("PerfectHomeToYou.Data.Models.Client", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
